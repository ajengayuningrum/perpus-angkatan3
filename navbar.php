    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navAltMarkup">
            <div class="navbar-nav">
                ...
                <a href="?pg=kategori" class="nav-link">Kategori</a>
                <a href="?pg=book" class="nav-link">Book</a>
                <a href="?pg=level" class="nav-link">Level</a>
                <a href="?pg=anggota" class="nav-link">Anggota</a>
                <a href="?pg=peminjaman" class="nav-link">Peminjaman</a>
                <a href="?pg=pengembalian" class="nav-link">Pengembalian</a>
            </div>
