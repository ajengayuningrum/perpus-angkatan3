                    ...
                    <div class="mb-3 row">
                        <div class="col-sm-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="no_peminjaman" value="<?php echo isset($_GET['detail']) ? $rowPinjam['no_peminjaman'] : $kode_pinjam ?>" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label">Tanggal Peminjaman</label>
                                <input required type="date" class="form-control" name="tgl_peminjaman" value="<?php echo isset($_GET['detail']) ?  $rowPinjam['tgl_peminjaman'] : '' ?>" readonly>
                            ...
                            <?php if (empty($_GET['detail'])) : ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select required="" id="id_book" class="form-control">
                        ...
                        <div class="col-sm-4">
                            <div class="mb-3">
                                ...
                                <?php else: ?>
                                    <input type="text" class="form-control" readonly value="<?php echo $rowPinjam['nama_anggota'] ?>">
                                <?php endif ?>
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label">Tanggal Pengembalian</label>
                                <input required type="date" class="form-control" name="tgl_pengembalian" value="<?php echo isset($_GET['detail']) ? $rowPinjam['tgl_pengembalian'] : '' ?>" readonly>
                            </div>
                        </div>
                        <?php if (empty($_GET['detail'])): ?>
